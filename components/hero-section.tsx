...
export const HeroSection = forwardRef<HTMLInputElement, HeroSectionProps>(
  function HeroSection(
    ...
    return (
      <section className="text-center overflow-hidden">
        <div className="inline-flex items-center gap-2 bg-muted px-2.5 py-1 rounded-full text-sm">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight mt-6">
          Consigue el #{displayRank} por{' '}
          <span className="inline-flex items-center gap-1 sm:gap-2 text-primary align-middle">
            <button
              type="button"
              onClick={handleDecrease}
              className="inline-flex items-center justify-center size-8 sm:size-10 rounded-full bg-primary/10"
            >
            ...
            <input
              ...
              className="bg-transparent border-none outline-none text-primary text-center font-bold"
              size={bidText.length}
            />
        ...
        <p className="text-muted-foreground mt-3 text-base sm:text-lg max-w-3xl mx-auto px-4">
          Puedes entrar desde 1 €. No necesitas pagar por el nº1: tu puja te
          coloca automáticamente en la posición que alcance.
        </p>
        ...
        <div className="mt-8 max-w-lg mx-auto px-4">
          ...
          <p className="text-xs text-muted-foreground mt-3">
            ¿Ya estás en la lista? Introduce la misma URL o @usuario y aumenta
            tu puja. Solo pagarás la diferencia.
          </p>
        </div>
      </section>
    );
